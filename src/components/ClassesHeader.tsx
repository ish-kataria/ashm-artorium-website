    ...
    <section className="py-16 bg-gradient-to-r from-purple-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
          Choose the perfect package for your artistic journey. From single demo classes to comprehensive
          8-week programs, we offer flexible options to suit every schedule and skill level.
        </p>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 max-w-lg mx-auto">
          ...
          <p className="text-xs text-gray-600">
            4-week package from $135 • 8-week package from $245 (best value)
          </p>
        </div>
      </div>
    </section>
